    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent(main_activity.this, error_correct.class);
        ...
        adjust.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = new Intent(main_activity.this, com.example.asus.zhishui.adjust.class);
                startActivity(intent);
            }
        });
        ...
        bottomTabs.setTabSelectedListener(new BottomNavigationBar.OnTabSelectedListener() {
            ...
            public void onTabSelected(int position) {
                switch (position) {
                    case 0:
                        Log.i("1","choose book!");
                        Intent intent = new Intent(main_activity.this, bookpage.class);
                        startActivity(intent);
                        break;
                    case 1:
                        Log.i("1","choose index!");
                        Intent intent1 = new Intent(main_activity.this, main_activity.class);
                        startActivity(intent1);
                        break;
                    case 2:
                        Log.i("1","choose me!");
                        Intent intent2 = new Intent(main_activity.this, me.class);
