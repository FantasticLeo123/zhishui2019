    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correct.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent intent = new Intent(MainActivity.this, errorcorrect.class);
        ...
        adjust.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                Intent intent = new Intent(MainActivity.this, Adjust.class);
                startActivity(intent);
            }
        });
        ...
        bottomTabs.setTabSelectedListener(new BottomNavigationBar.OnTabSelectedListener() {
            ...
            public void onTabSelected(int position) {
                switch (position) {
                    ...
                    case 2:
                        Log.i("1","choose me!");
                        Intent intent2 = new Intent(MainActivity.this, Me.class);
