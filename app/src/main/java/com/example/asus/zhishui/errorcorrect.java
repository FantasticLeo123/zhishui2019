...
public class errorcorrect extends AppCompatActivity {
    // 多个系列的数据集合,即多条线的数据集合
        ...
        bottomTabs.setTabSelectedListener(new BottomNavigationBar.OnTabSelectedListener() {
            ...
            public void onTabSelected(int position) {
                switch (position) {
                    case 0:
                        Log.i("1","choose book!");
                        Intent intent = new Intent(errorcorrect.this, book.class);
                        startActivity(intent);
                        break;
                    case 1:
                        Log.i("1","choose index!");
                        Intent intent1 = new Intent(errorcorrect.this, MainActivity.class);
                        startActivity(intent1);
                        break;
                    case 2:
                        Log.i("1","choose me!");
                        Intent intent2 = new Intent(errorcorrect.this, Me.class);
