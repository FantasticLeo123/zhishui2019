...
public class error_correct extends AppCompatActivity {
    // 多个系列的数据集合,即多条线的数据集合
            ...
            public void onTabSelected(int position) {
                switch (position) {
                    ...
                    case 1:
                        ...
                        Intent intent1 = new Intent(error_correct.this, main_activity.class);
                        startActivity(intent1);
                        break;
                    case 2:
                        Log.i("1","choose me!");
                        Intent intent2 = new Intent(error_correct.this, me.class);
